@extends ('backend.layouts.app', ['title' => 'Create Template'])
            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Create template</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form method="POST" action="{{ route('backend.bank.store') }}" enctype="multipart/form-data" class="form form-vertical">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                @enderror" name="bank_name" placeholder="Bank Name">
                                                @error('bank_name')
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                @enderror" name="account_number" placeholder="Account Number">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    @enderror" name="account_name" placeholder="Account Name">
                                                    @error('account_name')
                                                        <div class="text-danger text-start">
                                                            <i class="fa-solid fa-triangle-exclamation"></i> {{ $message }}
                                                    @enderror
